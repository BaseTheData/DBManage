...
<HTML>
	...
	ResultSet rs = stmt.executeQuery("SELECT Store_hold_Item.item_id as items, Store_hold_Item.store_id as stores, city.city_name as cityname, store.phone as phone FROM Store_hold_Item, store, city WHERE (Store_hold_Item.item_id IN (SELECT Order_contains_items.item_id FROM Order_contains_items WHERE Order_contains_items.order_no = Orders.order_no AND Orders.Customer_id ='"+a+"')) AND Store_hold_Item.store_id=store.store_id AND store.city_id=city.city_id;");
	%>
